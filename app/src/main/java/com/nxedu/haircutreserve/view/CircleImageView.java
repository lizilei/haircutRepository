...
public class CircleImageView extends ImageView {
    ...
    private static final int DEFAULT_BORDER_WIDTH = 1;// 默认描边宽度
    private static final int DEFAULT_BORDER_COLOR = Color.WHITE;// 默认描边颜色
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a
                .getDimensionPixelSize(
                        R.styleable.CircleImageView_border_widthc,
                        DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CircleImageView_border_colorc,
