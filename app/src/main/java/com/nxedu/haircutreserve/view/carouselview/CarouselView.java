...
//                        new LinearLayout.LayoutParams(pageItemWidth + ConversionUtil.dip2px(context, 3), height + ConversionUtil.dip2px(context, 3));
                        new LinearLayout.LayoutParams(pageItemWidth + ConversionUtil.dip2px(context, 3),
                                pageItemWidth + ConversionUtil.dip2px(context, 3));
                params.setMargins(pageItemWidth, 0, 0, 0);
                view.setLayoutParams(params);
            } else {
                LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(pageItemWidth, height);
                params.setMargins(pageItemWidth, 0, 0, 0);
                view.setLayoutParams(params);
            }
    ...
    protected void onFinishInflate() {
        ...
        pageItemWidth = ConversionUtil.dip2px(context, 5);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (position % showCount == i) {
                ...
                LinearLayout.LayoutParams params =
                        new LinearLayout.LayoutParams(pageItemWidth + ConversionUtil.dip2px(context, 3)
                                , pageItemWidth + ConversionUtil.dip2px(context, 3));
//                                , height + ConversionUtil.dip2px(context, 3));
                params.setMargins(pageItemWidth, 0, 0, 0);
                view.setLayoutParams(params);
            } else {
